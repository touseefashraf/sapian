...
@NgModule({
    ...
    exports: [
        ...
        CommonModule, SuffixPipe, LoaderComponent, ResponseComponent, PageNotFoundComponent, SmartClickDirective, ReadMoreComponent, IAlertsModule, IRatingModule, FileSizeConverterPipe
    ]
})
